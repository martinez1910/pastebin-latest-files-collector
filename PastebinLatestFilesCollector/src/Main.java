...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Getting the source code of the URL: " +(t2-t1));
		
		t1 = System.currentTimeMillis();
		//Get list with names
		listFileNames = extractNames(sourceCode);
		t2 = System.currentTimeMillis();
		System.out.println("Getting the list with names: " +(t2-t1));
		...
		t2 = System.currentTimeMillis();
		System.out.println("Getting the list with texts: " +(t2-t1));
		...
		t2 = System.currentTimeMillis();
		System.out.println("Getting the files locally: " +(t2-t1));
